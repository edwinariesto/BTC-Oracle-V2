...
export const translations: Record<Language, Translations> = {
  id: {
    ...
    pilihNaikTurun: 'Pilih NAIK ▲, TURUN ▼, atau SAMA =',
    ...
    aturan: 'Aturan Main',
    rule1: 'Klik NAIK ▲, TURUN ▼, atau SAMA = untuk simpan harga BTC saat ini',
    ...
    salahDepositKeOwner: 'SALAH! Deposit 0.10 MON masuk ke owner',
    benarDapatReward: 'BENAR! Dapat reward MON',
    stepBerikutnya: 'Step berikutnya: {step}',
    resetKeStep1: 'Di-reset ke Step 1!',
    drawMessage: 'SERI! Tidak ada perubahan harga — Maju ke Step berikutnya + Dapat reward',
    winMessage: 'MENANG! {reward} MON — Maju ke Step berikutnya',
  ...
  en: {
    ...
    pilihNaikTurun: 'Choose UP ▲, DOWN ▼, or SAME =',
    ...
    aturan: 'Game Rules',
    rule1: 'Click UP ▲, DOWN ▼, or SAME = to store the current BTC price',
    ...
    salahDepositKeOwner: 'WRONG! 0.10 MON deposit goes to owner',
    benarDapatReward: 'CORRECT! Got MON reward',
    stepBerikutnya: 'Next step: {step}',
    resetKeStep1: 'Reset to Step 1!',
    drawMessage: 'DRAW! No price change — Advance to next Step + Get reward',
    winMessage: 'WIN! {reward} MON — Advance to next Step',
